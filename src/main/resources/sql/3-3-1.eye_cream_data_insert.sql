...
-- 상품: [화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g...
INSERT INTO product (name, description, rating_avg, category_id, brand_id, status, created_at, updated_at) VALUES
('[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g',
 '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g',
 4.8,
 (SELECT id FROM category WHERE name = '아이크림' ORDER BY id DESC LIMIT 1),
 (SELECT id FROM brand WHERE name = '에스네이처'),
...
INSERT INTO product_opt-- 상품: 닥터멜락신 아이팔트 아이백 아이크림 7g + 10g 듀오세트...
INSERT INTO product (name, description, rating_avg, category_id, brand_id, status, created_at, updated_at) VALUES
    ('닥터멜락신 아이팔트 아이백 아이크림 7g + 10g 듀오세트',
     '닥터멜락신 아이팔트 아이백 아이크림 7g + 10g 듀오세트',
     4.9,
...
INSERT INTO product_option (name, additional_amount, product_id) VALUES
    ('기본 옵션', 0, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_price (price, type, product_id, created_at, updated_at) VALUES
                                                                                (29000, 'ORIGINAL', (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'), NOW(), NOW()),
                                                                                (14900, 'SALE', (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'), NOW(), NOW());

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122640ko.jpg?l=ko', 1, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122646ko.jpg?l=ko', 2, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122645ko.jpg?l=ko', 3, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122644ko.jpg?l=ko', 4, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122643ko.jpg?l=ko', 5, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020122642ko.jpg?l=ko', 6, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));

INSERT INTO inventory (stock_status, quantity, product_option_id, updated_at)
SELECT 'SELLING', 100, po.id, NOW()
FROM product_option po
         JOIN product p ON po.product_id = p.id
WHERE p.name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g';


-- ================================

-- 상품: 라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)...
INSERT INTO product (name, description, rating_avg, category_id, brand_id, status, created_at, updated_at) VALUES
    ('라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)',
     '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)',
     4.9,
     (SELECT id FROM category WHERE name = '아이크림' ORDER BY id DESC LIMIT 1),
     (SELECT id FROM brand WHERE name = '라로제'),
     '판매중',
     NOW(),
     NOW());

INSERT INTO product_option (name, additional_amount, product_id) VALUES
    ('기본 옵션', 0, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_price (price, type, product_id, created_at, updated_at) VALUES
                                                                                (44000, 'ORIGINAL', (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'), NOW(), NOW()),
                                                                                (44000, 'SALE', (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'), NOW(), NOW());

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137806ko.jpg?l=ko', 1, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137805ko.jpg?l=ko', 2, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137804ko.jpg?l=ko', 3, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137803ko.jpg?l=ko', 4, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137802ko.jpg?l=ko', 5, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0020/A00000020137801ko.jpg?l=ko', 6, (SELECT id FROM product WHERE name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)'));

INSERT INTO inventory (stock_status, quantity, product_option_id, updated_at)
SELECT 'SELLING', 100, po.id, NOW()
FROM product_option po
         JOIN product p ON po.product_id = p.id
WHERE p.name = '라로제 안티퍼티그 아이 컨투어 스틱 15ml (수분스틱)';


-- ================================

-- 상품: [10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)...
INSERT INTO product (name, description, rating_avg, category_id, brand_id, status, created_at, updated_at) VALUES
    ('[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)',
     '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)',
     4.8,
     (SELECT id FROM category WHERE name = '아이크림' ORDER BY id DESC LIMIT 1),
     (SELECT id FROM brand WHERE name = '유세린'),
...
INSERT INTO product_option (name, additional_amount, product_id) VALUES
    ('기본 옵션', 0, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_price (price, type, product_id, created_at, updated_at) VALUES
                                                                                (53000, 'ORIGINAL', (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'), NOW(), NOW()),
                                                                                (53000, 'SALE', (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'), NOW(), NOW());

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439018ko.jpg?l=ko', 1, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439013ko.jpg?l=ko', 2, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439014ko.jpg?l=ko', 3, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439011ko.jpg?l=ko', 4, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439006ko.jpg?l=ko', 5, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO product_img (img_url, img_order, product_id) VALUES
    ('https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/550/10/0000/0022/A00000022439016ko.jpg?l=ko', 6, (SELECT id FROM product WHERE name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)'));

INSERT INTO inventory (stock_status, quantity, product_option_id, updated_at)
SELECT 'SELLING', 100, po.id, NOW()
FROM product_option po
         JOIN product p ON po.product_id = p.id
WHERE p.name = '[10년연속1위] 유세린 하이알루론 3X 아이크림 15ml (기프트패키지)';


-- ================================
ion (name, additional_amount, product_id) VALUES
('기본 옵션', 0, (SELECT id FROM product WHERE name = '[화해3관왕/영양탄력] 에스네이처 아쿠아 소이 요거 아이크림 25g'));
